...
const metroStations = {
  ...
  "Banashankari Station": {
    "Jayanagar Station": 5,
    "Yelachenahalli Station": 10,
  },
  "Indiranagar Station": {
    "MG Road Station": 15,
    "Banashankari Station": 15, 
  },
  "Yelachenahalli Station": {
    "Banashankari Station": 10,
    "Kengeri Station": 15, 
  },
};
...
function calculate() {
  ...
  // if source and destination are not selected
  ...
  document.getElementById("fare").textContent = fare + " units"; // You can replace 'units' with your INR (rupees)
}
